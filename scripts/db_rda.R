...
print(p_dbrda)
ggsave(here("figures", "dbrda_final_10_nitrogen.png"),
...
ggsave(here("figures", "variable_importance_unique.png"), p_importance, 
       width = 10, height = 6, dpi = 300, bg = "white")
ggsave(here("figures", "variable_importance_comparison.png"), p_marginal_unique, 
       width = 10, height = 6, dpi = 300, bg = "white")
...
print(p_combined)
ggsave(here("figures", "dbrda_3panel.png"), width = 24, height = 10, dpi = 400, bg = "white")
...
ggsave(here("figures", "cluster2_temporal_pattern.png"), 

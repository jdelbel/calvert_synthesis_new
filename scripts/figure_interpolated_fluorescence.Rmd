...
ggsave(here("figures","fluorescence_mei_analysis.png"), combined_plot,
       width = 14, height = 12, 
       dpi = 300)
```
...
common_x_breaks <- seq(as.Date("2017-01-01"), as.Date("2024-01-01"), by = "1 year")
common_x_labels <- format(common_x_breaks, "%Y")
common_x_limits <- c(as.Date("2017-01-01"), as.Date("2023-12-31"))
...
mei_plot_data <- mei_data %>%
  ...
  filter(plot_date >= as.Date("2017-01-01") & 
...
# Save
ggsave(here("figures", "panel_kc10_interp_int_mei.png"), 
       combined_plot,
       width = 16, 
       height = 12,
       dpi = 300)
...
# Save
ggsave(here("figures", "panel_kc10_interp_int_fw-total_mei.png"), 
       combined_plot,
       width = 16, 
       height = 14,
       dpi = 300)
...
# Save
ggsave(here("figures", "discharge_relationships.png"), 
       discharge_plot,
       width = 14, 
       height = 6, 
       dpi = 300)
